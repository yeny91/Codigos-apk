...
while True:
    qtCreatorFile = "Apk-sensores-tres.ui" # Nombre del archivo aquí.
    ...
    class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
        ...
        # Aqui va el boton
            ...
            self.analizar.clicked.connect(self.leeranalizar)
        ...
        def leeranalizar(self):
            ...
            while  arduino.inWaiting() > 0:    
                   txt= arduino.readline()
                   texto_st= "ESTADO: "+str(txt) 
                   self.resanalizar.setText(texto_st)      
